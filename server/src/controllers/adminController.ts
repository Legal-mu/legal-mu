            ...
            if (lawyerProfile && (role === UserRole.LAWYER || user.role === UserRole.LAWYER)) {
                await tx.lawyerProfile.upsert({
                    ...
                    create: {
                        ...
                        legalCategory: lawyerProfile.legalCategory,
                        address: lawyerProfile.address,
                        city: lawyerProfile.city,
                        postal_code: lawyerProfile.postal_code,
                        country: lawyerProfile.country,
                        phoneNumber: lawyerProfile.phoneNumber,
                        practiceAreas: lawyerProfile.practiceAreas || [],
                        admissionYear: lawyerProfile.admissionYear,
                        experienceYears: lawyerProfile.experienceYears || 0,
                        languages: lawyerProfile.languages || [],
                        workExperience: lawyerProfile.workExperience || [],
                        cvUrl: lawyerProfile.cvUrl,
                        biography: lawyerProfile.biography || '',
                        extendedBiography: lawyerProfile.extendedBiography,
                        headshotUrl: lawyerProfile.headshotUrl,
                        websiteUrl: lawyerProfile.websiteUrl,
                        linkedinUrl: lawyerProfile.linkedinUrl,
                        twitterUrl: lawyerProfile.twitterUrl,
                        youtubeUrl: lawyerProfile.youtubeUrl,
                        showGoogleReviews: lawyerProfile.showGoogleReviews ?? false,
                        googleBusinessProfileUrl: lawyerProfile.googleBusinessProfileUrl,
                        clientTestimonials: lawyerProfile.clientTestimonials || [],
                        featuredSuccessStories: lawyerProfile.featuredSuccessStories,
                        verifiedBadges: lawyerProfile.verifiedBadges || [],
                        clientDataUploadEnabled: lawyerProfile.clientDataUploadEnabled ?? false,
                        clientUploadNotificationEmail: lawyerProfile.clientUploadNotificationEmail,
                        authorizedFileTypes: lawyerProfile.authorizedFileTypes || ["PDF", "DOCX", "JPG"]
                    },
                    update: {
                        ...
                        twitterUrl: lawyerProfile.twitterUrl,
                        youtubeUrl: lawyerProfile.youtubeUrl,
                        showGoogleReviews: lawyerProfile.showGoogleReviews,
                        googleBusinessProfileUrl: lawyerProfile.googleBusinessProfileUrl,
                        clientTestimonials: lawyerProfile.clientTestimonials,
                        featuredSuccessStories: lawyerProfile.featuredSuccessStories,
                        verifiedBadges: lawyerProfile.verifiedBadges,
                        clientDataUploadEnabled: lawyerProfile.clientDataUploadEnabled,
                        clientUploadNotificationEmail: lawyerProfile.clientUploadNotificationEmail,
                        authorizedFileTypes: lawyerProfile.authorizedFileTypes
                    }
                });
            }
