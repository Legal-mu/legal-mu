...
import { CTASection } from '@/components/practice-area';
...
export default function BlogPage() {
  return (
    <div className="min-h-screen bg-[#F6F8FF] font-jost">
      ...
      <main className="pt-40 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero */}
        ...
        <section className="bg-white rounded-[32px] rounded-tl-none shadow-sm border border-gray-100 overflow-hidden relative">
          ...
          <div className="border-t border-gray-100 px-8 md:px-12 py-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <Link
                href="/resources/articles-blogs/navigating-the-2024-mauritius-companies-act-amendments"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12">
            ...
            <div>
              <div className="mb-8">
                ...
                <div className="h-[2px] bg-[#1A2853]/70 w-[360px] sm:w-[520px] md:w-full mt-2" />
              </div>
