...
import { CategoryFilter, PracticeAreaCard, Pagination, CTASection } from '@/components/practice-area';
...
export default function PracticeAreaPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F6F8FF] font-jost">
            ...
            <main className="pt-40 pb-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Back Link */}
                <Link
                    href="/resources"
